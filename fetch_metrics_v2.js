const { YahooFinanceAPI } = require('yahoo-finance2');

// Try another approach with YahooFinanceAPI
...
// Function to fetch and analyze ticker data using historical method
async function analyzeTicker(ticker) {
    try {
        console.log(`Fetching data for ${ticker}...`);
        
        // Try using historical method instead
        ...
        const closePrices = data.map(d => d.close).filter(p => p != null);
